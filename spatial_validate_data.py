...
class DataSet():
    def __init__(self, class_limit=None, image_shape=(224, 224), original_image_shape=(341, 256), n_snip=5, opt_flow_len=10, batch_size=16):
        ...
        self.static_frame_path = os.path.join( ROOT_DIR +'/dataset/hk', 'test')
        self.opt_flow_path = os.path.join(ROOT_DIR + '/dataset/hk', 'opt_flow')
    ...
    def get_data_list():
        ...
        with open(os.path.join(ROOT_DIR + '/dataset/hk', 'data_list.csv'), 'r') as fin:
    ...
    def get_static_frame(self, row):
        ...
        total_frames = len(os.listdir(static_frame_dir))
